...
public class UnDeployRules  implements java.io.Serializable {
    private com.search.webservice.model.TransportList in0;

    public UnDeployRules() {
    }
    ...
    /**
     * Gets the in0 value for this UnDeployRules.
     * 
     * @return in0
     */
    ...
    /**
     * Sets the in0 value for this UnDeployRules.
     * 
     * @param in0
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UnDeployRules)) return false;
        UnDeployRules other = (UnDeployRules) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UnDeployRules.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.search.com/client", ">unDeployRules"));
