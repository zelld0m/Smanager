...
public class RecallRules  implements java.io.Serializable {
    ...
    /**
     * Gets the in0 value for this RecallRules.
     * 
     * @return in0
     */
    ...
    /**
     * Sets the in0 value for this RecallRules.
     * 
     * @param in0
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RecallRules)) return false;
        RecallRules other = (RecallRules) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RecallRules.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.search.com/client", ">recallRules"));
