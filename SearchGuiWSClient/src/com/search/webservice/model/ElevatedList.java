...
public class ElevatedList  implements java.io.Serializable {
    private com.search.manager.model.ElevateResult[] list;
    ...
    public ElevatedList(
           com.search.manager.model.ElevateResult[] list,
    ...
    /**
     * Gets the list value for this ElevatedList.
     * 
     * @return list
     */
    public com.search.manager.model.ElevateResult[] getList() {
        return list;
    }


    /**
     * Sets the list value for this ElevatedList.
     * 
     * @param list
     */
    public void setList(com.search.manager.model.ElevateResult[] list) {
        this.list = list;
    }


    /**
     * Gets the map value for this ElevatedList.
     * 
     * @return map
     */
    ...
    /**
     * Sets the map value for this ElevatedList.
     * 
     * @param map
     */
    ...
    /**
     * Gets the store value for this ElevatedList.
     * 
     * @return store
     */
    ...
    /**
     * Sets the store value for this ElevatedList.
     * 
     * @param store
     */
    ...
    /**
     * Gets the token value for this ElevatedList.
     * 
     * @return token
     */
    ...
    /**
     * Sets the token value for this ElevatedList.
     * 
     * @param token
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ElevatedList)) return false;
        ElevatedList other = (ElevatedList) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ElevatedList.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://model.webservice.search.com", "ElevatedList"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("list");
        elemField.setXmlName(new javax.xml.namespace.QName("http://model.webservice.search.com", "list"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://model.manager.search.com", "ElevateResult"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        elemField.setItemQName(new javax.xml.namespace.QName("http://model.manager.search.com", "ElevateResult"));
