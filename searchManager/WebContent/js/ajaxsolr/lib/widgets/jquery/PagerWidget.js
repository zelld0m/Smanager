// $Id: PagerWidget.js,v 1.4 2012/03/20 04:07:56 mpanalig Exp $
...
AjaxSolr.PagerWidget = AjaxSolr.AbstractWidget.extend(
  ...
  renderLinks: function (links) {
    if (this.totalPages) {
      if (this.currentPage > 1) links.unshift(this.pageLinkOrSpan(this.previousPage(), [ 'pager-disabled', 'pager-prev' ], this.prevLabel));
      if (this.currentPage < this.totalPages) links.push(this.pageLinkOrSpan(this.nextPage(), [ 'pager-disabled', 'pager-next' ], this.nextLabel));
  ...
  afterRequest: function () {
    ...
    var qTime = parseInt(this.manager.response.responseHeader.QTime);
