(function($){
	...
	$.activerule = function(el, options){
		...
		base.getData = function(){
			...
			$.getJSON(
					GLOBAL_solrUrl.replace(configURL,currentURL) + GLOBAL_storeId + "/select?rows=0&wt=json&json.nl=map&gui=" + $.parseJSON(GLOBAL_solrConfig)["isFmGui"] + "&q=" + base.options.keyword,
