...
//			template  += '		<h3 class="padT10"></h3>';
		...
		base.getAddFacetItemTemplate = function(){
			...
			template  += '						<img id="preloaderCategoryList" class="floatR loadIcon marL3 top6" src="' +  GLOBAL_contextPath + '/images/ajax-loader-rect.gif" style="display: none"/>';
			...
			template  += '					<td>';
			template  += '						<img id="preloaderSubCategoryList" class="floatR loadIcon marL3 top6" src="' +  GLOBAL_contextPath + '/images/ajax-loader-rect.gif" style="display: none"/>';
			template  += '						<div class="floatL">';
			...
			template  += '					<td>';
			template  += '						<img id="preloaderClassList" class="floatR loadIcon marL3 top6" src="' +  GLOBAL_contextPath + '/images/ajax-loader-rect.gif" style="display: none"/>';
			template  += '						<div class="floatL">';
			...
			template  += '					<td>';
			template  += '						<img id="preloaderMinorList" class="floatR loadIcon marL3 top6" src="' +  GLOBAL_contextPath + '/images/ajax-loader-rect.gif" style="display: none"/>';
			template  += '						<div class="floatL">';
			...
			template  += '					<td>';
			template  += '						<img id="preloaderManufacturerList" class="floatR loadIcon marL3 top6" src="' +  GLOBAL_contextPath + '/images/ajax-loader-rect.gif" style="display: none"/>';
			template  += '						<div class="floatL">';
			...
			template  += '								<img src="' +  GLOBAL_contextPath + '/images/iconDelete.png" class="deleteAttrIcon posRel floatR marT8 marR8 marL5" alt="Delete Attribute" title="Delete Attribute">';
