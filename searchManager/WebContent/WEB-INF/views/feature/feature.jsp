...
<c:set var="topmenu" value="featured"/>
...
<!--  scroller -->
<link type="text/css" href="<spring:url value="/css/scroller.css" />" rel="stylesheet">
...
<script type="text/javascript">
	instantiateScroller(0, "scroll0", 7, 0, 391, 270, 270);
</script>
  ...
  <!--Left Menu-->
    ...
    <div class="companyLogo"><a href="#"><img src="<spring:url value="/images/logoMacMall.png" />"></a></div>
      ...
      <div class="clearB floatL w240">
        <div class="sideHeader">Keyword</div>
        <div class="clearB floatL w230 padL10">
          ...
          <div class="farial fsize12 fDGray w220 borderB padTB5">    
          	<span style="padding-top:7px">
            	...
            	<input type="text" id="searchFilter" name="searchFilter" class="farial fsize12 fgray leftSearch" onkeyup="javascript:fillTable();">           	  
           </span>
          </div>          
     		...
     		<tbody id="keywordBody">
     			<tr id="kDispPattern" style="display:none;"><td>
		          <div class="keywordHolder farial fsize12 fDGray w220 borderB padTB4 clearfix">
		          	...
		          	<div class="keywordLink floatL txtAR w60"><a href="javascript:void(0);"></a></div>
		          </div>     			
     			</td></tr>
     		</tbody>
          </table>
    ...
    <div class="floatL w730 marL10 marT27">
      <div class="floatL w730 titlePlacer marB20">
      	<div class="w460 padT10 padL10 floatL fsize20 fnormal">Feature</div>
      ...
      <!-- end item content -->
       ...
       <div class="viewport">
           <ul class="overview">                   	
               ...
               <li>  
               		<div class="iconDel"><a id="sItemDelete" href="javascript:void(0);"><img src="<spring:url value="/images/btn_delete_graybg.jpg" />" class="noborder"></a></div>                     	                                                                
                 	<div class="img"><div id="sItemStampExp" class="stampExpiredSm"><img src="<spring:url value="/images/expired_stamp90x40.png" />" class="noborder"></a> </div><a href="#"><img src="<spring:url value="/images/productItems/item2.jpg" />"></a></div>
                 	<p class="fsize14 fbold txtAC">lorem ipsum</p>                            		
                    <p class="shortDesc">MacMall <span class="fgreen">Part #:</span> 5555555</p>                                                                      
              ...
              <li>
              		<div class="iconDel"><a id="sItemDelete" href="javascript:void(0);"><img src="<spring:url value="/images/btn_delete_graybg.jpg" />" class="noborder"></a></div>                     	                                       
                 	<div class="img"><a href="#"><img src="<spring:url value="/images/productItems/item2.jpg" />"></a></div>
                 	<p class="fsize14 fbold txtAC">lorem ipsum</p>                            		
                    <p class="shortDesc">MacMall <span class="fgreen">Part #:</span> 1200678</p>
               </li> 
               
               <li>  
               		<div class="iconDel"><a id="sItemDelete" href="javascript:void(0);"><img src="<spring:url value="/images/btn_delete_graybg.jpg" />" class="noborder"></a></div>                     	                                                                       	                     
                 	<div class="img"><a href="#"><img src="<spring:url value="/images/productItems/item1.jpg" />"></a></div>
                 	<p class="fsize14 fbold txtAC">IBM</p>                            		
                    <p class="shortDesc"><span class="fgreen">Part #:</span> 7871419</p>                                                                                                                
               </li>
               <li>
               		<div class="iconDel"><a id="sItemDelete" href="javascript:void(0);"><img src="<spring:url value="/images/btn_delete_graybg.jpg" />" class="noborder"></a></div>                     	                                       
                 	<div class="img"><a href="#"><img src="<spring:url value="/images/productItems/item2.jpg" />"></a></div>
                 	<p class="fsize14 fbold txtAC">lorem ipsum</p>                            		
                    <p class="shortDesc"><span class="fgreen">Part #:</span> 666666</p>                                                                     
               </li> 
               <li>
               		<div class="iconDel"><a id="sItemDelete" href="javascript:void(0);"><img src="<spring:url value="/images/btn_delete_graybg.jpg" />" class="noborder"></a></div>                     	                                       
                 	<div class="img"><a href="#"><img src="<spring:url value="/images/productItems/item2.jpg" />"></a></div>
                 	<p class="fsize14 fbold txtAC">lorem ipsum</p>                            		
                    <p class="shortDesc"><span class="fgreen">Part #:</span> 1200678</p>                                                                    
               </li> 
        ...
        </div><!-- end slider menu --><div class="clearboth"></div>
