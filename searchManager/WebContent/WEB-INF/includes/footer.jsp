...
instantiateScroller(0, "scroll0", 7, 0, 220, 260, 260);
    ...
    <div class="clearB floatL w980 padT20 padB25">
      <div class="farial fgray bgFooter" style="margin-bottom:40px">
      		...
      		<div class="floatL txtcopyright txtAR w360">&#169; <script> document.write(new Date().getFullYear());</script> PCM Sales, Inc.</div>
      </div>
  ...
  <div class="footerFix">
  	<div style="width:1024px; margin: 0 auto; padding:5px 10px"> 
  		<div class="floatL w45p fsize12 padT7"><img src="<spring:url value="/js/jquery/ajaxsolr.custom/images/user.png" />" class="marBn3 marR3"> Welcome <sec:authentication property="principal.username" /></span></div>
