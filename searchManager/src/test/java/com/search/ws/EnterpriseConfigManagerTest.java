...
public class EnterpriseConfigManagerTest {
    ...
    @Test
    public void testGetDefaultRelevancyNotNull(){
        assertNotNull(enterpriseConfigManager.getDefaultRelevancy("pcmall"));
        assertNotNull(enterpriseConfigManager.getDefaultRelevancy("pcoe"));
        assertNotNull(enterpriseConfigManager.getDefaultRelevancy("pcmallgov"));
        assertNotNull(enterpriseConfigManager.getDefaultRelevancy("pcmgoe"));
        assertNotNull(enterpriseConfigManager.getDefaultRelevancy("pcmgfed"));
        assertNotNull(enterpriseConfigManager.getDefaultRelevancy("pcmgfedoe"));
        assertNotNull(enterpriseConfigManager.getDefaultRelevancy("pcmgsl"));
        assertNotNull(enterpriseConfigManager.getDefaultRelevancy("pcmgsloe"));
        assertNotNull(enterpriseConfigManager.getDefaultRelevancy("pcmgedk12"));
        assertNotNull(enterpriseConfigManager.getDefaultRelevancy("pcmgedk12oe"));
        assertNotNull(enterpriseConfigManager.getDefaultRelevancy("pcmgedhe"));
        
        assertNotNull(enterpriseConfigManager.getDefaultRelevancy("macmall"));
        assertNotNull(enterpriseConfigManager.getDefaultRelevancy("mmoe"));
        assertNotNull(enterpriseConfigManager.getDefaultRelevancy("mmrt"));
        assertNotNull(enterpriseConfigManager.getDefaultRelevancy("ecost"));
        assertNotNull(enterpriseConfigManager.getDefaultRelevancy("ecoe"));
    }
 }