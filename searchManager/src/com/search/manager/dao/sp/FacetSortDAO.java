...
public class FacetSortDAO {
		...
		protected void declareSqlReturnResultSetParameters() {
			declareParameter(new SqlReturnResultSet(DAOConstants.RESULT_SET_1, new RowMapper<FacetSort>() {
				public FacetSort mapRow(ResultSet rs, int rowNum) throws SQLException
				{
					...
					facetSort.setCreatedDateTime(JodaDateTimeUtil.toDateTime(rs.getTimestamp(DAOConstants.COLUMN_CREATED_STAMP)));
					facetSort.setLastModifiedDateTime(JodaDateTimeUtil.toDateTime(rs.getTimestamp(DAOConstants.COLUMN_LAST_UPDATED_STAMP)));
		...
		protected void declareSqlReturnResultSetParameters() {
			declareParameter(new SqlReturnResultSet(DAOConstants.RESULT_SET_1, new RowMapper<FacetGroup>() {
				...
				{	
					...
					facetGroup.setCreatedDateTime(JodaDateTimeUtil.toDateTime(rs.getTimestamp(DAOConstants.COLUMN_CREATED_STAMP)));
					facetGroup.setLastModifiedDateTime(JodaDateTimeUtil.toDateTime(rs.getTimestamp(DAOConstants.COLUMN_LAST_UPDATED_STAMP)));
		...
		protected void declareSqlReturnResultSetParameters() {
			declareParameter(new SqlReturnResultSet(DAOConstants.RESULT_SET_1, new RowMapper<FacetGroupItem>() {
				public FacetGroupItem mapRow(ResultSet rs, int rowNum) throws SQLException
				{
					...
					facetGroupItem.setCreatedDateTime(JodaDateTimeUtil.toDateTime(rs.getTimestamp(DAOConstants.COLUMN_CREATED_STAMP)));
					facetGroupItem.setLastModifiedDateTime(JodaDateTimeUtil.toDateTime(rs.getTimestamp(DAOConstants.COLUMN_LAST_UPDATED_STAMP)));
	...
	public RecordSet<FacetSort> searchFacetSort(SearchCriteria<FacetSort> criteria, MatchType matchType) throws DaoException {
		try {
	        ...
	        inputs.put(DAOConstants.PARAM_MATCH_TYPE, (matchType == null) ? "" : matchType.getIntValue());
	        inputs.put(DAOConstants.PARAM_SORT_TYPE, (sortType==null)? sortType: sortType.toString());
