...
public class SpellIndex {
	...
	private static final Logger logger = LoggerFactory
			.getLogger(SpellIndex.class);

	private static final String BASE_RULE_DIR = PropsUtils.getValue("rulepath");
	private static final String TEMP_RULE_DIR = PropsUtils
			.getValue("temprulepath");
	...
	public void init() throws Exception {
		dirPath = new StringBuilder()
				...
				.append(RuleEntity.getValue(ENTITY.getCode()) != null ? RuleEntity
						.getValue(ENTITY.getCode()) : ENTITY.name()).toString();
	...
	public void load(String store) throws Exception {
		if (xmlPath.get(store) == null) {
			String storeDir = new StringBuilder().append(dirPath)
					.append(File.separator).append(store).toString();
			String spellFile = new StringBuilder().append(storeDir)
