...
public enum CatCodes {
	SQL_OBJECTS(0, "Sql Objects"),
	FIELD_DEFINITIONS(1, "Field Definitions"),
	...
	SOLR_TEMPLATE_STORE(7, "Solr_Template_Store_XRef"),
	SOLR_TEMPLATE_ATTRIBUTE(8, "Solr_Template_Attribute_XRef"),
	SOLR_ATTRIBUTE_RANGE(9, "Solr_Attribute_Range_Values"),
	SOLR_ATTRIBUTE_RANGE_XREF(10, "Solr_Attribute_Range_Value_XRef"),
	SOLR_SEARCH_NAV(11, "SOLR_Search_Nav"),
	MACMALL_EDP(12, "MacMall_EDP"),
	MACMALL_EDP_LIST(13, "MacMall_EDP_ListAttributes"),
	...
	LEVEL3(995, "Level 3"),
	LEVEL4(994, "Level 4"),
	SOLR_ATTRIBUTES(993, "Solr_Attribute_Master");
