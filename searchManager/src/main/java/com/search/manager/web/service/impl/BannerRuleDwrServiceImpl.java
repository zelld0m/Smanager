...
import com.search.manager.web.service.BannerRuleDwrService;

@Component
@RemoteProxy(name = "BannerRuleService", creator = SpringCreator.class, creatorParams = @Param(name = "beanName", value = "bannerRuleService"))
public class BannerRuleDwrServiceImpl implements BannerRuleDwrService {
    ...
    @RemoteMethod
    @Override
    public ServiceResponse<SearchResult<BannerRule>> getAllRules(String storeId, String searchText, int page,
            int pageSize) {
        ServiceResponse<SearchResult<BannerRule>> serviceResponse = new ServiceResponse<SearchResult<BannerRule>>();
        try {
            serviceResponse.success(bannerRuleService.getAllRules(storeId, searchText, page, pageSize));
        } catch (CoreServiceException e) {
    ...
    @RemoteMethod
    @Override
    public ServiceResponse<SearchResult<BannerRule>> getRulesByImageId(String storeId, String imagePathId,
            String imageAlias, int page, int pageSize) {
        ServiceResponse<SearchResult<BannerRule>> serviceResponse = new ServiceResponse<SearchResult<BannerRule>>();

        try {
            serviceResponse.success(bannerRuleService.getRulesByImageId(storeId, imagePathId, imageAlias, page,
                    pageSize));
        } catch (CoreServiceException e) {
    ...
    public ServiceResponse<BannerRule> getRuleByName(String storeId, String ruleName) {
        ServiceResponse<BannerRule> serviceResponse = new ServiceResponse<BannerRule>();
        try {
            serviceResponse.success(bannerRuleService.getRuleByName(storeId, ruleName));
        } catch (CoreServiceException e) {
            serviceResponse.error(String.format(MSG_FAILED_RETRIVAL_BY_NAME, ruleName), e);
        }
        return serviceResponse;
    }
    ...
    public ServiceResponse<BannerRule> getRuleById(String storeId, String ruleId) {
        ServiceResponse<BannerRule> serviceResponse = new ServiceResponse<BannerRule>();
        try {
            serviceResponse.success(bannerRuleService.getRuleById(storeId, ruleId));
        } catch (CoreServiceException e) {
            serviceResponse.error(String.format(MSG_FAILED_RETRIVAL_BY_ID, ruleId), e);
        }
    ...
    public ServiceResponse<Integer> getTotalRulesByImageId(String storeId, String imagePathId, String imageAlias) {
        ...
        try {
            serviceResponse.success(bannerRuleService.getTotalRulesByImageId(storeId, imagePathId, imageAlias));
        } catch (CoreServiceException e) {
            serviceResponse.error(MSG_FAILED_COUNT_RETRIVAL_BY_IMAGE_PATH_ID, e);
        }
        return serviceResponse;
    }
    ...
    public ServiceResponse<List<String>> copyToRule(String storeId, String[] keywords, Map<String, String> params) {
        ...
        try {
            serviceResponse.success(bannerRuleService.copyToRule(storeId, keywords, params));
        } catch (CoreServiceException e) {
    ...
    @RemoteMethod
    @Override
    public ServiceResponse<RecordSet<BannerStatistics>> getBannerStats(String storeId, String keyword, String memberId,
        ...
        try {
            serviceResponse.success(bannerRuleService.getBannerStats(storeId, keyword, memberId, startDateText,
    ...
    @RemoteMethod
    @Override
    public ServiceResponse<RecordSet<BannerStatistics>> getStatsByKeyword(String storeId, String keyword,
            String startDateText, String endDateText, boolean aggregate) {
        ServiceResponse<RecordSet<BannerStatistics>> serviceResponse = new ServiceResponse<RecordSet<BannerStatistics>>();
        try {
            serviceResponse.success(bannerRuleService.getStatsByKeyword(storeId, keyword, startDateText, endDateText,
                    aggregate));
        } catch (CoreServiceException e) {
            // TODO create error message.
    ...
    @RemoteMethod
    @Override
    public ServiceResponse<RecordSet<BannerStatistics>> getStatsByMemberId(String storeId, String memberId,
            String startDateText, String endDateText) {
        ServiceResponse<RecordSet<BannerStatistics>> serviceResponse = new ServiceResponse<RecordSet<BannerStatistics>>();
        try {
            serviceResponse
                    .success(bannerRuleService.getStatsByMemberId(storeId, memberId, startDateText, endDateText));
        } catch (CoreServiceException e) {
            // TODO create error message.
