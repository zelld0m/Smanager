...
public class KeywordAttributeDaoConstant {

	public static final String COLUMN_KEYWORD_ATTRIBUTE_ID = "KEYWORD_ATTRIBUTE_ID";
	public static final String COLUMN_KEYWORD_ID = "KEYWORD_ID";
	public static final String COLUMN_INPUT_PARAM_ENUM_ID = "INPUT_PARAM_ENUM_ID";

	public static final String COLUMN_PARENT_ATTRIBUTE_ID = "PARENT_ATTRIBUTE_ID";
