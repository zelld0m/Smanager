...
public class RequestProcessorUtil {
    ...
    public Map<String, String> getFacetMap(String storeId) {
        ...
        facetMap.put(SolrConstants.SOLR_PARAM_FACET_NAME,
                configManager.getStoreParameter(storeId, SolrConstants.SOLR_PARAM_FACET_NAME));
        facetMap.put(SolrConstants.SOLR_PARAM_FACET_TEMPLATE,
                configManager.getStoreParameter(storeId, SolrConstants.SOLR_PARAM_FACET_TEMPLATE));
        facetMap.put(SolrConstants.SOLR_PARAM_FACET_TEMPLATE_NAME,
                configManager.getStoreParameter(storeId, SolrConstants.SOLR_PARAM_FACET_TEMPLATE_NAME));
        return facetMap;
    }
