...
public interface AuditTrailService extends GenericService<AuditTrail> {
    ...
    List<String> getRefIDs(String entity, String operation, String storeId) throws CoreServiceException;

    List<String> getDropdownValues(int type, String storeId, boolean adminFlag) throws CoreServiceException;
