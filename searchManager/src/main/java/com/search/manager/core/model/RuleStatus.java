...
public class RuleStatus extends ModelBean {
    ...
    public RuleStatus(RuleEntity ruleEntity, String storeId, String ruleId, String ruleName, String createdBy,
            String modifiedBy, RuleStatusEntity ruleStatus, RuleStatusEntity publishedStatus) {
        this.createdBy = createdBy;
        this.lastModifiedBy = modifiedBy;
