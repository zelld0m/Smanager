...
public class SqlSearchProcessor extends BaseSearchProcessor implements SearchProcessor {
    ...
    protected String toFilterQuery(Filter filter) {
        ...
        switch (operator) {
            ...
            case CUSTOM:
                return null; // TODO
            default:
                throw new IllegalArgumentException("Filter operator ( " + operator + " ) is invalid.");
        }
    }
