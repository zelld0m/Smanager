...
public class BannerRuleItemServiceSpImpl implements BannerRuleItemService {
    ...
    @Override
    public List<BannerRuleItem> add(Collection<BannerRuleItem> models) throws CoreServiceException {
        try {
            // TODO validation here...
    ...
    @Override
    public BannerRuleItem update(BannerRuleItem model) throws CoreServiceException {
        try {
            // TODO validation here...
    ...
    @Override
    public List<BannerRuleItem> update(Collection<BannerRuleItem> models) throws CoreServiceException {
        try {
    ...
    @Override
    public Map<BannerRuleItem, Boolean> delete(Collection<BannerRuleItem> models) throws CoreServiceException {
        try {
            // TODO validation here...
    ...
    @Override
    public SearchResult<BannerRuleItem> search(Search search) throws CoreServiceException {
        try {
            // TODO validation here...
    ...
    @Override
    public SearchResult<BannerRuleItem> search(BannerRuleItem model) throws CoreServiceException {
        if (model != null) {
            try {
    ...
    @Override
    public SearchResult<BannerRuleItem> search(BannerRuleItem model, int pageNumber, int maxRowCount)
    ...
    @Override
    public BannerRuleItem searchById(String storeId, String id) throws CoreServiceException {
        if (StringUtils.isNotBlank(storeId) && StringUtils.isNotBlank(id)) {
            ...
            SearchResult<BannerRuleItem> searchResult = search(bannerRuleItem, 1, 1);

            if (searchResult.getTotalCount() > 0) {
                return (BannerRuleItem) CollectionUtils.get(searchResult.getResult(), 0);
            }
        }
        return null;
    }
    ...
    @Override
    public BannerRuleItem transfer(BannerRuleItem bannerRuleItem) throws CoreServiceException {
        ...
        if (bannerRule != null && imagePath != null && StringUtils.isNotBlank(bannerRule.getRuleId())
                && StringUtils.isNotBlank(imagePath.getId()) && StringUtils.isNotBlank(bannerRuleItem.getCreatedBy())
    ...
    @Override
    public List<BannerRuleItem> getActiveBannerRuleItems(String storeId, String keyword, DateTime currentDate)
            throws CoreServiceException {
        if (StringUtils.isNotBlank(storeId) || StringUtils.isNotBlank(keyword) || currentDate != null) {
    ...
    @Override
    public BannerRuleItem addRuleItem(String storeId, Map<String, String> params) throws CoreServiceException {
        ...
        ImagePath newImagePath = new ImagePath(storeId, imagePathId, imagePath, imageSize, ImagePathType.IMAGE_LINK,
                imageAlias);
        ...
        if (StringUtils.isBlank(imagePathId)) {
            try {
                ...
                if (newImagePath != null) {
                    newImagePath = imagePathService.getImagePath(storeId, imagePath);
                } else {
        ...
        BannerRuleItem bannerRuleItem = new BannerRuleItem(rule, null, priority, startDT, endDT, imageAlt, linkPath,
                description, newImagePath, disable, openNewWindow);

        return add(bannerRuleItem);
    }

    @Override
    public Integer getTotalRuleItems(String storeId, String ruleId) throws CoreServiceException {
    ...
    @Override
    public SearchResult<BannerRuleItem> getRuleItemsByFilter(String storeId, String ruleId, String filter,
            String dateFilter, String imageSize, int page, int pageSize) throws CoreServiceException {
        ...
        search.addFilter(new Filter(DAOConstants.PARAM_IMAGE_SIZE, StringUtils.isNotBlank(imageSize) ? imageSize : null));
        search.addFilter(new Filter(DAOConstants.PARAM_DISABLED, BooleanUtils.toIntegerObject(disabled, 1, 0, null)));
        search.addFilter(new Filter(DAOConstants.PARAM_START_DATE, jodaDateTimeUtil.toSqlDate(startDate)));
        search.addFilter(new Filter(DAOConstants.PARAM_END_DATE, jodaDateTimeUtil.toSqlDate(endDate)));
    ...
    @Override
    public SearchResult<BannerRuleItem> getRuleItemsByImageId(String storeId, String imageId, int page, int pageSize)
            throws CoreServiceException {
    ...
    @Override
    public SearchResult<BannerRuleItem> getRuleItemsByRuleId(String storeId, String ruleId, int page, int pageSize)
            throws CoreServiceException {
        BannerRuleItem bannerRuleItem = new BannerRuleItem();
        BannerRule bannerRule = new BannerRule();
        bannerRule.setStoreId(storeId);
    ...
    @Override
    public SearchResult<BannerRuleItem> getAllRuleItems(String storeId, String ruleId) throws CoreServiceException {
        return getRuleItemsByRuleId(storeId, ruleId, -1, -1);
    }

    @Override
    public BannerRuleItem getRuleItemByMemberId(String storeId, String ruleId, String memberId)
            throws CoreServiceException {
        BannerRuleItem bannerRuleItem = new BannerRuleItem();
        BannerRule bannerRule = new BannerRule();
        bannerRule.setStoreId(storeId);
        ...
        if (bannerRuleItems.getTotalCount() > 0) {
            return (BannerRuleItem) CollectionUtils.get(bannerRuleItems.getResult(), 0);
        }
    ...
    @Override
    public BannerRuleItem updateRuleItem(String storeId, Map<String, String> params) throws CoreServiceException {
        ...
        if (StringUtils.isNotBlank(ruleId) && StringUtils.isNotBlank(memberId) && StringUtils.isNotBlank(storeId)) {
            ...
            if (StringUtils.isNotBlank(priority) && StringUtils.isNumeric(priority) && Integer.parseInt(priority) > 0) {
            ...
            if (StringUtils.isNotBlank(imagePathId) && StringUtils.isBlank(imagePath)
                    && StringUtils.isNotBlank(imageAlias)) {
                // update alias
                ImagePath imagePathUpdated = imagePathService.updateImagePathAlias(imagePathId, imageAlias);

                if (imagePathUpdated == null) {
                    throw new CoreServiceException("Error: updateImagePathAlias()");
                }
            } else {
    ...
    @Override
    public Boolean deleteRuleItemsByImageSize(String storeId, String ruleId, String imageSize)
            throws CoreServiceException {
        BannerRuleItem bannerRuleItem = new BannerRuleItem(ruleId, storeId);
        bannerRuleItem.setImagePath(new ImagePath(storeId, null, null, imageSize, null, null));

        return delete(bannerRuleItem);
    }

    @Override
    public Boolean deleteRuleItemByMemberId(String storeId, String ruleId, String memberId, String alias,
