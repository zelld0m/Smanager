...
public class RuleStatusDaoSpImpl extends GenericDaoSpImpl<RuleStatus> implements RuleStatusDao {
    ...
    private class SearchStoredProcedure extends GetStoredProcedure {
        ...
        protected void declareParameters() {
            ...
            declareParameter(new SqlParameter(DAOConstants.PARAM_STORE_ID, Types.VARCHAR));
            declareParameter(new SqlParameter(DAOConstants.PARAM_SORT_BY, Types.VARCHAR));
        }
    ...
    @Override
    protected Map<String, Object> generateAddInput(RuleStatus model) throws CoreDaoException {
        ...
        if (model != null) {
            ...
            inputs.put(DAOConstants.PARAM_APPROVED_STATUS, model.getApprovalStatus());
            ...
            inputs.put(DAOConstants.PARAM_LAST_REQUEST_DATE, jodaDateTimeUtil.toSqlDate(model.getLastRequestDate()));
            inputs.put(DAOConstants.PARAM_LAST_APPROVAL_DATE, jodaDateTimeUtil.toSqlDate(model.getLastApprovalDate()));
        }
    ...
    @Override
    protected Map<String, Object> generateUpdateInput(RuleStatus model) throws CoreDaoException {
        Map<String, Object> inputs = null;
        ...
        if (model != null) {
            ...
            inputs.put(DAOConstants.PARAM_EXPORT_TYPE, model.getExportType() != null ? model.getExportType().toString()
                    : null);
            inputs.put(DAOConstants.PARAM_LAST_REQUEST_DATE, jodaDateTimeUtil.toSqlDate(model.getLastRequestDate()));
            inputs.put(DAOConstants.PARAM_LAST_APPROVAL_DATE, jodaDateTimeUtil.toSqlDate(model.getLastApprovalDate()));
            inputs.put(DAOConstants.PARAM_LAST_PUBLISHED_DATE, jodaDateTimeUtil.toSqlDate(model.getLastPublishedDate()));
            inputs.put(DAOConstants.PARAM_LAST_EXPORT_DATE, jodaDateTimeUtil.toSqlDate(model.getLastExportDate()));
        }
    ...
    @Override
    protected Map<String, Object> generateDeleteInput(RuleStatus model) throws CoreDaoException {
        Map<String, Object> inputs = null;

        // TODO do we delete?
        if (model != null) {
            inputs = new HashMap<String, Object>();
            inputs.put(DAOConstants.PARAM_RULE_STATUS_ID, model.getRuleStatusId());
        }
    ...
    @Override
    protected Search generateSearchInput(RuleStatus model) throws CoreDaoException {
        if (model != null) {
            ...
            if (model.getRuleTypeId() != null) {
                search.addFilter(new Filter(DAOConstants.PARAM_RULE_TYPE_ID, model.getRuleTypeId()));
            }
            if (StringUtils.isNotBlank(model.getRuleRefId())) {
                search.addFilter(new Filter(DAOConstants.PARAM_REFERENCE_ID, model.getRuleRefId()));
            }
            if (StringUtils.isNotBlank(model.getPublishedStatus())) {
                search.addFilter(new Filter(DAOConstants.PARAM_PUBLISHED_STATUS, model.getPublishedStatus()));
            }
            if (StringUtils.isNotBlank(model.getApprovalStatus())) {
                search.addFilter(new Filter(DAOConstants.PARAM_APPROVED_STATUS, model.getApprovalStatus()));
            }
            if (StringUtils.isNotBlank(model.getUpdateStatus())) {
                search.addFilter(new Filter(DAOConstants.PARAM_EVENT_STATUS, model.getUpdateStatus()));
            }
    ...
    public List<String> getCleanList(List<String> ruleRefIds, Integer ruleTypeId, String pStatus, String aStatus)
        ...
        return searchSp.getJdbcTemplate().query(sBuilder.toString(), new RowMapper<String>() {
