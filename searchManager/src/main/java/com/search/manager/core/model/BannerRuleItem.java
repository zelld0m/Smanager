...
public class BannerRuleItem extends ModelBean {
    ...
    public BannerRuleItem(BannerRule rule, String memberId, Integer priority, DateTime startDate, DateTime endDate,
            String imageAlt, String linkPath, String description, ImagePath imagePath, Boolean disabled,
    ...
    public BannerRuleItem(String ruleId, String storeId, String ruleName, String memberId, int priority,
            DateTime startDate, DateTime endDate, String imageAlt, String linkPath, String description,
            ImagePath imagePath, Boolean disabled, Boolean openNewWindow) {
        this(new BannerRule(storeId, ruleId, ruleName, null), memberId, priority, startDate, endDate, imageAlt,
                linkPath, description, imagePath, disabled, openNewWindow);
    }
    ...
    public boolean isStarted() {
        return DateTime.now().toDateMidnight().isAfter(getStartDate().toDateMidnight())
                || DateTime.now().toDateMidnight().isEqual(getStartDate().toDateMidnight());
    }
    ...
    public void setSolrStartDate(Date startDate) {
        this.startDate = JodaDateTimeUtil.toDateTime(startDate, DateTimeZone.UTC);
    }
    ...
    public String getSolrId() {
        return this.rule.getStoreId() + "_" + this.rule.getRuleId() + "_" + this.getMemberId();
    }
