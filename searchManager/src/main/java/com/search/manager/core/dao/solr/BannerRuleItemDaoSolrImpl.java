...
public class BannerRuleItemDaoSolrImpl extends GenericDaoSolrImpl<BannerRuleItem> implements BannerRuleItemDao {
    ...
    protected Search generateQuery(BannerRuleItem model) {
        ...
        if (model != null) {
            ...
            if (model.getOpenNewWindow() != null) {
                filters.add(new Filter("openNewWindow", model.getOpenNewWindow()));
            }
