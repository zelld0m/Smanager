...
public interface AuditTrailDao extends GenericDao<AuditTrail> {
    ...
    List<String> getRefIDs(String ent, String opt, String storeId) throws CoreDaoException;

    List<String> getDropdownValues(int type, String storeId, boolean adminFlag) throws CoreDaoException;
