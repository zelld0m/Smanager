...
public class TaskExecutionResult {
    ...
    public TaskExecutionResult(TaskStatus taskStatus, String taskErrorMessage, int runAttempt,
            ImportType stateCompleted, DateTime taskStartDateTime, DateTime taslEmdDateTime) {
