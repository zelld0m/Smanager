        ...
        switch (operator) {
            ...
            case OR:
                if (!(value instanceof List)) {
                    return (operator == FilterOperator.AND ? "AND: " : "OR: ") + "Invalid value - NOT a List: ("
                            + value + ")";
                }
                ...
                if (first) {
                    return (operator == FilterOperator.AND ? "AND: " : "OR: ") + " Invalid value - null/empty List.";
                } else {
                    sb.append(")");
                    return sb.toString();
                }
            ...
            case CUSTOM:
                // TODO
            default:
                return "Invalid filter Operator: " + operator + " Value: " + SearchUtil.paramDisplayString(value);
        }
    }
