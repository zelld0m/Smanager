...
public class IndexBuilderUtil {
    ...
    private static final Logger logger =
            LoggerFactory.getLogger(IndexBuilderUtil.class);
    ...
    public static void saveIndexData(String logPath,
        ...
        try {
            ...
            e.printStackTrace();
            logger.error("Error at IndexBuilderUtil.saveIndexData(String,List<SolrInputDocument>,String)", e);
        } finally {
            try {
                if (out != null) {
                    out.close();
    ...
    public static void saveIndexData(String logPath,
        ...
        try {
            ...
            e.printStackTrace();
            logger.error("Error at IndexBuilderUtil.saveIndexData(String,SolrInputDocument,String)", e);
        } finally {
            try {
                if (out != null) {
                    out.close();
