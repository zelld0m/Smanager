...
/**
 * A top level Spring MVC exception handler that handles all exceptions from out Spring
 * MVC controllers.
 */
public class TopLevelLoggingExceptionHandler implements HandlerExceptionResolver {
    ...
    private static final Logger logger =
            LoggerFactory.getLogger(TopLevelLoggingExceptionHandler.class);
    ...
    /**
     * Log HTTP exceptions forwarded by the Web Container, via our error entries in the
     * web.xml
     */
    @RequestMapping
