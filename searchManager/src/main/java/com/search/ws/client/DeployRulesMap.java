...
public class DeployRulesMap implements Serializable {

	private static final long serialVersionUID = 1L;

	private TransportList in0;

	public DeployRulesMap() {
	}

	public DeployRulesMap(TransportList in0) {
		this.in0 = in0;
	}

	/**
	 * Gets the in0 value for this DeployRulesMap.
	 * 
	 * @return in0
	 */
	...
	/**
	 * Sets the in0 value for this DeployRulesMap.
	 * 
	 * @param in0
	 */
	...
	public synchronized boolean equals(Object obj) {
		if (!(obj instanceof DeployRulesMap))
			return false;
		DeployRulesMap other = (DeployRulesMap) obj;
	...
	// Type metadata
	private static TypeDesc typeDesc = new TypeDesc(DeployRulesMap.class, true);

	static {
		typeDesc.setXmlType(new QName("http://ws.search.com/client", ">deployRulesMap"));
