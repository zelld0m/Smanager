...
public class UnDeployRulesMapResponse implements Serializable {

	private static final long serialVersionUID = 1L;

	private AnyType2AnyTypeMapEntry[] out;

	public UnDeployRulesMapResponse() {
	}

	public UnDeployRulesMapResponse(AnyType2AnyTypeMapEntry[] out) {
		this.out = out;
	}

	/**
	 * Gets the out value for this UnDeployRulesMapResponse.
	 * 
	 * @return out
	 */
	...
	/**
	 * Sets the out value for this UnDeployRulesMapResponse.
	 * 
	 * @param out
	 */
	...
	public synchronized boolean equals(Object obj) {
		if (!(obj instanceof UnDeployRulesMapResponse))
			return false;
		UnDeployRulesMapResponse other = (UnDeployRulesMapResponse) obj;
	...
	// Type metadata
	private static TypeDesc typeDesc = new TypeDesc(UnDeployRulesMapResponse.class, true);

	static {
		typeDesc.setXmlType(new QName("http://ws.search.com/client", ">unDeployRulesMapResponse"));
