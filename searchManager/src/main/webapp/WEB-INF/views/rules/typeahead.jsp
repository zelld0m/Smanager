...
<div class="floatL w730 marL10 marT27">
	...
	<div id="facetsorting"
		...
		<div>
			<div style="width: 695px">
				...
				<span class="floatR"><a href="javascript:void(0);"
					id="downloadIcon"><div class="btnGraph btnDownload marT1 marL3"
							id="downloadIcon" alt="Download" title="Download"></div></a></span> <span
					class="floatR"><img class="pointer" id="auditIcon"
					src="<spring:url value="/images/icon_history.png" />" alt="History"
					title="History"></span> <span class="floatR"><label>Sort
						Order</label><select id="facetSortOrder" class="posRel topn3 marR5"></select></span>
			</div>
		</div>
		<div class="clearB"></div>
		...
		<div id="facetsort" class="tabvs marT10">
			<ul id="facetGroupTab">
				<li class="facetGroupTabPattern" style="display: none;"><a
					href="#noTab"><span class="facetGroupName"></span></a></li>
			</ul>

			<div class="facetTabPattern contentWrapper" style="display: none;">
				<div class="sort marT10 fgray">
					<ul>
						<li><input id="facetGroupCheckbox" type="checkbox" />Use
							this sort order for this group</li>
				...
				<div class="catValueTop floatL w47p">
					...
					<div>
						<ul id="selectedFacetValueList" class="marT8">
							<li id="addFacetValuePattern" class="addFacetValuePattern handle"
								style="display: none;">
								<div class="floatL">
									<img src="<spring:url value="/images/icon_move.png" />"
										class="posRel top3" />
								</div>
								<div class="marL5 w207"
									style="display: block; float: left; width: 210px !important; position: relative; top: -5px;">
									<select id="facetValuesPattern"
										class="selectCombo mar0 w185 marT6"></select>
								</div>
								<div class="deleteIcon">
									<img class="delFacetValueIcon"
			...
			<div class="marT10 txtAR">
				<a id="saveBtn" class="buttons btnGray clearfix"
					href="javascript:void(0);"><div class="buttons fontBold">Save</div></a>
				<a id="deleteBtn" class="buttons btnGray clearfix"
					href="javascript:void(0);" id=""><div class="buttons fontBold">Delete</div></a>
			</div>
		</div>
	</div>
	<!--  end horizontal tab -->
	...
	<div id="addFacetSortTemplate" style="display: none">
		<div class="w282 padT10 newFacetSort">
			<label class="floatL w80 txtLabel">Rule Type </label> <label
				class="floatL"> <select name="select" id="popType"
				class="selectCombo mar0 w200 floatR marT6" title="Select Rule Type">
			...
			<div id="keywordinput">
				<label class="floatL w80 txtLabel">Keyword </label> <label
					class="floatL"><input class="w194" id="popKeywordName"
					type="text" maxlength="100"></label>
			</div>
			<div class="clearB"></div>
			...
			<div id="templatelist" style="display: none;">
				...
				<div class="floatL w200">
					<select name="select" id="popName" class="selectCombo mar0 marT6"
						title="Select Template Name"></select>
				</div>
			</div>
			<div class="clearB"></div>

			<label class="floatL w80 txtLabel marT8">Sort Order</label> <label
				class="floatL marT8"> <select name="select"
				id="popSortOrder" class="selectCombo mar0 w200 floatR marT6"
				title="Select Sort Order"></select>
			</label>
			<div class="clearB"></div>

			<div class="txtAR pad3 marT10">
				<a id="addButton" href="javascript:void(0);"
					class="buttons btnGray clearfix">
					<div class="buttons fontBold">Save</div>
				</a> <a id="clearButton" href="javascript:void(0);"
					class="buttons btnGray clearfix">
					<div class="buttons fontBold">Clear</div>
				</a>
			</div>
		</div>
	</div>
