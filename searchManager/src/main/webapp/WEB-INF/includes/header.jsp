...
<title>Search Manager</title>
  ...
  <script type="text/javascript" src="<spring:url value="/js/jquery/min.1.8.16/jquery.ui.accordion.min.js" />" ></script>
...
<script type="text/javascript" src="<spring:url value="/js/ajax-solr-06-01-2013/widgets/TypeaheadCategory.js" />"></script>
  ...
  <script type="text/javascript" src="<spring:url value="/js/jquery/plugin.custom/jquery.copy.custom.js" />" ></script>
  ...
  <!-- Typeahead -->
  <script type="text/javascript" src="<spring:url value="/js/typeahead/typeahead_widget.js" />" ></script>
  <script type="text/javascript" src="<spring:url value="/js/typeahead/jquery.velocity.min.js" />" ></script>
