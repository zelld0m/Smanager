    ...
    var RedirectRule = {
            ...
            $("#submitForApproval").rulestatus({
                ...
                afterRuleStatusRequest: function(ruleStatus) {
                    ...
                    $("div#page").find("#redirectUrlBtn").off().on({
                        ...
                        click: function(evt) {
                            if (!evt.data.locked) {
                                var isValid = self.validateRedirectUrl();
        ...
        setActiveRedirectType: function() {
            ...
            switch (parseInt(self.selectedRule["redirectTypeId"])) {
                case 1:
                    $("div#filter").find('input#activate').prop({checked: true, disabled: true});
                    break;
                case 2:
                    $("div#keyword").find('input#activate').prop({checked: true, disabled: true});
                    break;
                case 3:
                    $("div#page").find('input#activate').prop({checked: true, disabled: true});
                    break;
            }
            ;
        },
        ...
        buildConditionAsMap: function(ui) {
            ...
            if (ui.find("div.ims").is(":visible")) {
                ...
                if (ui.find("a.switchToCatName").is(":visible")) {
                    if ($.isNotBlank(catCode[0]))
                        condMap["CatCode"] = catCode;
                } else {
                    if ($.isNotBlank(category[0]))
                        condMap["Category"] = category;
                    if ($.isNotBlank(subCategory[0]))
                        condMap["SubCategory"] = subCategory;
                    if ($.isNotBlank(clazz[0]))
                        condMap["Class"] = clazz;
                    if ($.isNotBlank(minor[0]))
                        condMap["SubClass"] = minor;
                }
                if ($.isNotBlank(manufacturer[0]))
                    condMap["Manufacturer"] = manufacturer;
            }
            ...
            if (ui.find("div.cnet").is(":visible")) {
                ...
                if ($.isNotBlank(level1Cat[0]))
                    condMap["Level1Category"] = level1Cat;
                if ($.isNotBlank(level2Cat[0]))
                    condMap["Level2Category"] = level2Cat;
                if ($.isNotBlank(level3Cat[0]))
                    condMap["Level3Category"] = level3Cat;
                if ($.isNotBlank(cnetManufacturer[0]))
                    condMap["Manufacturer"] = cnetManufacturer;
            }
            ...
            if (ui.find("div.facet").is(":visible")) {
                ...
                if ($.isNotBlank(platform)) {
                    switch (platform.toLowerCase()) {
                        case "universal":
                            condMap["Platform"] = ["Universal"];
                            break;
                        case "pc":
                            condMap["Platform"] = ["PC"];
                            break;
                        case "linux":
                            condMap["Platform"] = ["Linux"];
                            break;
                        case "macintosh":
                            condMap["Platform"] = ["Macintosh"];
                            break;
                    }
                }
                ...
                if ($.isNotBlank(condition)) {
                    switch (condition.toLowerCase()) {
                        case "refurbished":
                            condMap["Condition"] = ["Refurbished"];
                            break;
                        case "open box":
                            condMap["Condition"] = ["Open Box"];
                            break;
                        case "clearance":
                            condMap["Condition"] = ["Clearance"];
                            break;
                    }
                }
                ...
                if ($.isNotBlank(availability)) {
                    switch (availability.toLowerCase()) {
                        case "in stock":
                            condMap["Availability"] = ["In Stock"];
                            break;
                        case "call":
                            condMap["Availability"] = ["Call"];
                            break;
                    }
                }
                ...
                if ($.isNotBlank(license)) {
                    switch (license.toLowerCase()) {
                        case "license products only":
                            condMap["License"] = ["License Products Only"];
                            break;
                        case "non-license products only":
                            condMap["License"] = ["Non-License Products Only"];
                            break;
                    }
                }
                ...
                if ($.isNotBlank(imageExists)) {
                    switch (imageExists.toLowerCase()) {
                        case "products with image only":
                            condMap["ImageExists"] = ["Products With Image Only"];
                            break;
                        case "products without image only":
                            condMap["ImageExists"] = ["Products Without Image Only"];
                            break;
                    }
                }
