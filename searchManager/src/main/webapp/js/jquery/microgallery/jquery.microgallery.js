(function($) {
	...
	$.fn.build 				= function($this,o,mode,current,incfactor){
			...
			var $nav = $('<div/>',{
			    'class'	:	'nav',
				html	:	'<a class="thumbview grid"></a>' + autoplayHTML + '<div class="fsize11 floatL w100 padT5 padL5">6 Banners</div><button class="next"></button><button class="prev '+prevClass+'"></button>'
			});
			if(!o.menu){
				$nav.css('top','0px');
				$this.hover(
