// $Id: AbstractFacetWidget.js,v 1.5 2012/02/21 05:00:24 mpanalig Exp $
...
AjaxSolr.AbstractFacetWidget = AjaxSolr.AbstractWidget.extend(
  ...
  set: function (field, value) {
    return this.changeSelection(function () {
      var a = this.manager.store.removeByValue('fq', new RegExp('^-?' + field + ':')),
          b = this.manager.store.addByValue('fq', this.fq(field, value));
      return a || b;
    });
  },
  ...
  add: function (field, value) {
    return this.changeSelection(function () {
      return this.manager.store.addByValue('fq', this.fq(field, value));
    });
  },
  ...
  fq: function (field, value, exclude) {
    return (exclude ? '-' : '') + field + ':' + AjaxSolr.Parameter.escapeValue(value);
  }
});
