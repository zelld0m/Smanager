...
import com.mall.model.RedirectRuleSolr;
...
//			if (ruleSolrResult.getForceAdd().equals("true")) {
//				elevateResult.setForceAdd(true);
//			} else {
//				elevateResult.setForceAdd(false);
//			}
	...
	public static List<RedirectRule> toRedirectRule(
		...
		for (RedirectRuleSolr redirectRuleSolr : redirectRulesSolr) {
			...
			redirectRule.setIncludeKeyword(redirectRuleSolr.getIncludeKeyword());
